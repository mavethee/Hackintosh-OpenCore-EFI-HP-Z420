...
## Current Version: [OpenCore 1.0.1 DEBUG](https://github.com/acidanthera/OpenCorePkg/releases/tag/1.0.1) with [OCLP 2.0.1](https://github.com/dortania/OpenCore-Legacy-Patcher/releases/tag/2.0.1) running macOS 15.0 with success! :D
...
- [Notes for macOS Big Sur and Monterey if you insist](#big-sur-and-monterey-notes)
...
6. OCLP works with Sonoma the best with 1.5.0+. for Sequoia, it's active development so latest OCLP 2.0.1 is recommended.

7. While Legacy Metal dGPUs work for most part, there are still some issues.

8. Follow OCLP preparation steps:
...
0. Remove macOS 13+ related kexts:
...
1. macOS Monterey:
   ...
   This section is split in three parts, make sure to follow instructions for you case.
      ...
      a) For supported dGPUs, which since macOS 12.0 Beta 7 only AMD dGPUs (you can check [here](https://dortania.github.io/GPU-Buyers-Guide/modern-gpus/amd-gpu.html#native-amd-gpus))
...
2. macOS Big Sur:
   ...
   - If you want, you can also modify this EFI:
      ...
      a) Remove macOS 12+ and OCLP related kexts:
         - `EFI/OC/Kexts/AutoPkgInstaller.kext` (For macOS installer root patching with OCLP)
         - `EFI/OC/Kexts/ASPP-Override.kext` (For XCPM disabling on 12.3 Beta 1+)

      b) Remove OCLP prepartion steps, mentioned in Monterey step for supported dGPUs.

3. With that done, you can head to [Installation Guide](#installation),
