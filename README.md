...
## Current Version: [OpenCore 1.0.1 DEBUG](https://github.com/acidanthera/OpenCorePkg/releases/tag/1.0.1) with [OCLP 2.1.1](https://github.com/dortania/OpenCore-Legacy-Patcher/releases/tag/2.1.1) running macOS 15.1 with success! :D
