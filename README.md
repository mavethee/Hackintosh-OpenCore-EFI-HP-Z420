...
6. OCLP works with Sonoma the best with 1.5.0+! But with macOS Sequoia, it is supported since 2.0.0, but as it's active development, latest OCLP 2.0.1 is recommended (for Kepler dGPUs it's even mandatory!).
